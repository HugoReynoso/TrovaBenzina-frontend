...
export function CheapestStations({ stations, fuelType, serviceMode }: CheapestStationsProps) {
    ...
    <section aria-labelledby="piu-economici" className="rounded-md border border-ink/10 bg-white p-4 shadow-sm">
      ...
      <ol className="mt-4 grid gap-3">
        {stations.map((station, index) => {
          ...
          return (
            <li key={station.id} className="grid grid-cols-[auto_1fr_auto] gap-3 rounded-md bg-ink/[0.035] p-3">
